...
class derivatives_data:
    def __init__(self):
        ...
        self.liquidations_instance = self.Liquidations()
        self.cvd_data = self.cvd_data()
        self.skew=self.skew()
        self.volume_change=self.volume_change()
        self.iv = self.iv()
        self.market_depth = self.market_depth()
        self.ls_ratio=self.ls_ratio()
        self.funding_rate_ohlc=self.funding_rate_ohlc()
        self.oi_weight_ohlc=self.oi_weight_ohlc()
        self.fundingratevol=self.fundingratevol()
        self.oi_ohlc=self.oi_ohlc()
        self.oi_ohlc_aggregated_history=self.oi_ohlc_aggregated_history()
    ...
    class market_depth:
        url = "https://open-api-v3.coinglass.com/api/futures/orderbook/history?exchange=Binance&symbol=BTCUSDT&interval=12h"
        def get_order_book_depth(self, symbol="BTCUSDT", exchange="Binance", interval="12h"):
            headers = {
                "accept": "application/json",
                "CG-API-KEY": os.getenv('COINGLASS_KEY')  
            }
    ...
    class ls_ratio:
        def get_long_short_ratio(self, symbol="BTC", interval=30, exchName="Binance"):
            url = "https://open-api-v3.coinglass.com/api/futures/topLongShortAccountRatio/history?exchange=Binance&symbol=BTCUSDT&interval=h1"
            headers = {
                "accept": "application/json",
                "CG-API-KEY": os.getenv('COINGLASS_KEY')
            }
    ...
    class funding_rate_ohlc:
        ...
        def get_funding_rate_ohlc(self, symbol="BTCUSDT", exchange="Binance", interval="30m"):
            url = "https://open-api-v3.coinglass.com/api/futures/fundingRate/ohlc-history?exchange=Binance&symbol=BTCUSDT&interval=1d"
            headers = {
                "accept": "application/json",
    ...
    class oi_weight_ohlc:
        ...
        def get_oi_weight_ohlc_history(self, symbol="BTC", interval="30m"):
            url = "https://open-api-v3.coinglass.com/api/futures/fundingRate/oi-weight-ohlc-history?symbol=BTC&interval=12h"
            headers = {
                "accept": "application/json",
                "CG-API-KEY": os.getenv('COINGLASS_KEY')
            }
    ...
    class fundingratevol:
        def get_vol_weight_ohlc_history(self, symbol="BTC", interval="30m"):
            url = "https://open-api-v3.coinglass.com/api/futures/fundingRate/vol-weight-ohlc-history?symbol=BTC&interval=12h"
            headers = {
                "accept": "application/json",
                "CG-API-KEY": os.getenv('COINGLASS_KEY')
            }
    ...
    class oi_ohlc:
        def get_open_interest_ohlc_history(self, symbol="BTCUSDT", exchange="Binance", interval="30m"):
            url = "https://open-api-v3.coinglass.com/api/futures/openInterest/ohlc-history?exchange=Binance&symbol=BTCUSDT&interval=12h"
            headers = {
                "accept": "application/json",
                "CG-API-KEY": os.getenv('COINGLASS_KEY')
            }
    ...
    class oi_ohlc_aggregated_history:
        ...
        def get_ohlc_aggregated_history(self, symbol="BTC", interval="30m"):
            url = "https://open-api-v3.coinglass.com/api/futures/openInterest/ohlc-aggregated-history?symbol=BTC&interval=1d"
            headers = {
                "accept": "application/json",
                "CG-API-KEY": os.getenv('COINGLASS_KEY')
            }
